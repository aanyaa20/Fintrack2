    ...
    <div className="min-h-screen bg-[#1a1e2a] text-white">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center gap-3 mb-6">
          <BookOpen className="size-10 text-green-500" />
          <h1 className="text-4xl font-bold">Help Documents</h1>
        </div>

        <div className="prose prose-invert max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-green-500">Getting Started with Fintrack</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-green-500">Core Features Overview</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-green-500">Common Tasks</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
